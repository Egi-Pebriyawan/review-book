  ...
  <div>
    ...
    <div class="bg-white rounded-xl shadow-sm border p-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <NuxtLink to="/admin/books" class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
        ...
        <NuxtLink to="/admin/comments" class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
          <svg class="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
